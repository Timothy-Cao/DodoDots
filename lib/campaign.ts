...
import l06 from '@/content/campaign/06-level-6.json';
import l07 from '@/content/campaign/07-level-7.json';
import type { Level } from './level-format';

export const CAMPAIGN: Level[] = [l01, l02, l03, l04, l05, l06, l07] as Level[];
